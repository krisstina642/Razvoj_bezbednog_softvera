...
public class DeliveryRepository {
    ...
    public List<ViewableDelivery> getAllDeliveries() {
        ...
        try (Connection connection = dataSource.getConnection();
           ...
           LOG.warn("GetAllDeliveries failed ", e);
        }
        return deliveries;
    }
    ...
    public ViewableDelivery getDelivery(String id) {
             ...
             PreparedStatement statement = connection.prepareStatement(sqlQuery))
        {
            ...
            LOG.warn("GetDelivery failed for ID: "+id, e);
        }
        return null;
    }
    ...
    public List<DeliveryDetail> getDeliveryDetails(String id) {
             ...
             PreparedStatement statement = connection.prepareStatement(sqlQuery))
        {
            ...
            LOG.warn("GetDeliveryDetails failed for ID: "+id, e);
        }
        return details;
    }


    private DeliveryDetail createDetail(ResultSet rs) {
        int id = 0;
        int amount = 0;
        ...
        try {
            ...
            LOG.warn("createDetail failed ", e);
        }
    ...
    public List<ViewableDelivery> search(String searchQuery) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            statement.setString(1,searchQuery2);
            statement.setString(2,searchQuery2);
            statement.setString(3,searchQuery2);
            statement.setString(4,searchQuery2);
            statement.setString(5,searchQuery2);
            ResultSet rs = statement.executeQuery();
            while (rs.next()) {
                cars.add(createDelivery(rs));
            }
        } catch (SQLException throwables) {
            LOG.warn("SearchDelivery failed for searchQuery "+ searchQuery, throwables);
        }
        return cars;
    }
